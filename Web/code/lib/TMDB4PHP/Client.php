...
//https://github.com/kriboogh/TMDB4PHP

namespace TMDB;

include_once(dirname(__FILE__) . "/structures/Asset.php");
include_once(dirname(__FILE__) . "/structures/Collection.php");
include_once(dirname(__FILE__) . "/structures/Company.php");
include_once(dirname(__FILE__) . "/structures/Genre.php");
include_once(dirname(__FILE__) . "/structures/Movie.php");
include_once(dirname(__FILE__) . "/structures/Person.php");
