...
class TestFunctions extends UnitTestCase {
    ...
    function testSaveImageFromUrl() {
        ...
        $this->assertTrue(saveImageFromUrl(getUrlContent('~/TestFiles/videos/movies/FakeMovie2/folder.jpg'), $tempFile));
        ...
        //try an invalid url
        $this->assertFalse(saveImageFromUrl(getUrlContent('~/TestFiles/videos/RandomImageThatDoesNotExist.jpg'), $tempFile));
