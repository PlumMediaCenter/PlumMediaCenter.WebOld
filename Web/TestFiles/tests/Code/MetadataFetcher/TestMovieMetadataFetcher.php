...
class TestMovieMetadataFetcher extends UnitTestCase {
    ...
    function testFetchById_invalid() {
        $fetcher = new MovieMetadataFetcher();
        //there should be no movie with these titles
        $this->expectException();
    ...
    function verifyFetcher($fetcher) {
        ...
        $dateTime->setDate(1999, 10, 14);
        $dateTime->setTime(0, 0, 0);
        $this->assertEqual($dateTime, $fetcher->releaseDate());
        ...
        $this->assertEqual("http://image.tmdb.org/t/p/original/hpt3aa5i0TrSAnEdl3VJrRrje8C.jpg", $fetcher->posterUrl());
