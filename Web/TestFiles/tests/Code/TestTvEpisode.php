...
class TestTvEpisode extends UnitTestCase {
    ...
    function testFetchMetadata() {
        ...
        @unlink(dirname(__FILE__) . "/../videos/tv shows/The Dick Van Dyke Show/Season 1/show.s01.e01.nfo");
        $v = $this->loadTvShow("/The Dick Van Dyke Show/Season 1/show.s01.e01.mp4");
