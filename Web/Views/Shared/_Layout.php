...
<html>
    ...
    <body>
        ...
        <?php //Script section belongs at the bottom of the page so that the page appears to load faster. ?>
...
//                 $("#playlistAdder").playlistAdder({username: app.username});
...
//             }
        ...
        <?php renderSection('scripts', true); ?>
